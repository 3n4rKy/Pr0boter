...
int Java_com_piclienta_video_MjpegInputStream_pixeltobmp(JNIEnv* env,jobject thiz, jbyteArray jp, jint l, jobject bmp);
void Java_com_piclienta_video_MjpegInputStream_freeCameraMemory(JNIEnv* env,jobject thiz);
